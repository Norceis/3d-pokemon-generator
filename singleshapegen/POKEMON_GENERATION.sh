cd voxelization
python voxelize_for_interp.py -s '..\POKEMON\charizard\pm0006_00_00.obj' --res 150 --n_scales 5 -o '../POKEMON/charizard/charizard.h5'
python voxelize_for_interp.py -s '../POKEMON/charmander/pm0004_00_00.obj' --res 150 --n_scales 5 -o '../POKEMON/charmander/charmander.h5'
python voxelize_for_interp.py -s '../POKEMON/charmeleon/pm0005_00_00.obj' --res 150 --n_scales 5 -o '../POKEMON/charmeleon/charmeleon.h5'
cd ..

...
class SSGmodelTriplane(SSGmodelBase):
    ...
    def interpolation_pokemon(self, alpha_list: list, init_noise1_model2, init_noise2_model2, noises_list_model2):
        """inter(extra-)polation between two generated shapes
        ...
        print(f'\n\n\n\nModel 1: {init_noise1.shape, init_noise2.shape, noises_list[-1][0].shape}\n'
              f'Model 2: {init_noise1_model2.shape, init_noise2_model2.shape, noises_list_model2[-1][0].shape}\n\n')

        out_list = []
        with torch.no_grad():
            for i in range(len(alpha_list)):
                alpha = alpha_list[i]
                init_noise = (1 - alpha) * init_noise1 + alpha * init_noise1_model2
                out = self.netG(init_noise, self.real_sizes, noises_list, mode)
                out_list.append(out)

                alpha = alpha_list[i]
                init_noise = (1 - alpha) * init_noise1 + alpha * init_noise1_model2
                out = self.netG(init_noise, self.real_sizes, noises_list_model2, mode)
                out_list.append(out)

                alpha = alpha_list[i]
                init_noise = (1 - alpha) * init_noise2 + alpha * init_noise1_model2
                out = self.netG(init_noise, self.real_sizes, noises_list, mode)
                out_list.append(out)
                ...
                alpha = alpha_list[i]
                init_noise = (1 - alpha) * init_noise1 + alpha * init_noise2_model2
                out = self.netG(init_noise, self.real_sizes, noises_list, mode)
                out_list.append(out)
                ...
                alpha = alpha_list[i]
                init_noise = (1 - alpha) * init_noise2 + alpha * init_noise2_model2
                out = self.netG(init_noise, self.real_sizes, noises_list, mode)
                out_list.append(out)
    ...
    def return_noises_for_interp_pokemon(self):
        ...
        return init_noise1, init_noise2, noises_list
